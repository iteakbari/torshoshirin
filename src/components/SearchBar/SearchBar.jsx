  ...
  return (
    <>
      ...
      <div className="searchBar">
        ...
        <div
          className={`w-full border-2 px-3 lg:pt-12 overflow-y-auto overflow-x-hidden no-scroll  rounded-3xl transition-all duration-300 z-20 bg-white absolute top-0 left-0 right-0 ${
